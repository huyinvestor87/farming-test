...
const S = {
  vi: {
    ...
    seedShopUse: 'Trồng ngay (còn {n})', needFarmland: 'Chỉ trồng được trên luống đất nâu ở giữa nông trại',
  ...
  en: {
    ...
    seedShopUse: 'Plant now ({n} left)', needFarmland: 'You can only plant on the brown soil bed in the middle of the farm',
